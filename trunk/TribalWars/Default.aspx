<%@ Page Language="C#" MasterPageFile="~/outPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs"
    Inherits="index" Title="TribalWars - Trang chủ" %>
<%@ Reference Control="LoginBox.ascx" %>
<%@ Reference Control="PlayerBox.ascx" %>
