<%@ Page Title="" Language="C#" MasterPageFile="~/administrator/administrator.master" AutoEventWireup="true" CodeFile="create_text.aspx.cs" Inherits="administrator_create_text" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<center><h2>Tạo mới text</h2></center>
<asp:UpdatePanel runat="server" ID="updatePanel">
    <ContentTemplate>
        <div style="margin-bottom:10px;margin-top:10px;">
        <div style="width:100px;text-align:right;margin-right:5px;float:left;">Key: </div>
        <div style="float:left;"><asp:TextBox Width="800px" ID="txtKey" runat="server" ></asp:TextBox>
