...
<div class="login-block">
    ...
    <asp:TextBox ID="username" runat="server" ValidationGroup="Login" Width="200px"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="username"
        ValidationGroup="Login" ErrorMessage="RequiredFieldValidator" Text="Nhập username"></asp:RequiredFieldValidator>
    <br />
    Mật khẩu:<br />
    <asp:TextBox ID="password" runat="server" ValidationGroup="Login" TextMode="Password" Width="200px"></asp:TextBox>
